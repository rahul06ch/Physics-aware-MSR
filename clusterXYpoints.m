...
% Rahul Usage
% [clustersXY] = clusterXYpoints(XY_data,0.1,2,'point','merge')
%
%
...
%
%% Code
% function [clustersCentroids,clustersGeoMedians,clustersXY] = clusterXYpoints(XY_data,maxdist,minClusterSize,method,mergeflag)
function [clustersXY] = clusterXYpoints(XY_data,maxdist,minClusterSize,method,mergeflag)
% Default variables
